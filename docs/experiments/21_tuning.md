...
|---|---|---|---|---|
| submit_voting_tuned.csv (root) | 0.8761 | 0.8724 | +0.0037 | 健全 |
| submit_voting_weighted.csv (root) | 0.8795 | 0.8720 | +0.0075 | やや過学習気味 |
| submit_lgbm_tuned.csv (root) | 0.8786 | 0.8705 | +0.0081 | やや過学習気味 |
